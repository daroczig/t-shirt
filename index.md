...
{% highlight r %}
library(EBImage)
u <- readImage("useR.jpg")
str(u)
display(u)
print(u)
write.table(u@.Data,"text.txt",sep="\t")

#CONVERT DATA TO REPEATS
require(ggplot2)
require(RColorBrewer)
require(Cairo)
u1<-read.delim("useR.txt",header=F)
str(u1)
u2<-round(u1,0)
#get contiguous repeats
l1 <- rle(as.vector(t(as.matrix(u2))))$lengths
#print
paste(l1,collapse=",")
